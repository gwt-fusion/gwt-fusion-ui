...
- `gwt-fusion-query`: Data fetching, cache state, retry, invalidation, and mutation primitives under `org.gwtfusion.query`.
- `gwt-fusion-query-ui`: Optional query lifecycle renderers under `org.gwtfusion.query.ui`.
