...
final class PhosphorIconsDuotoneJ {
    private static final String[] NAMES = {"jar", "jar-label", "jeep", "joystick"};

    private PhosphorIconsDuotoneJ() {
    }
    ...
    static Icon jar() {
        return Icon.svg("0 0 256 256")
                ...
                .element("path", "d", "M208,88V200a32,32,0,0,1-32,32H80a32,32,0,0,1-32-32V88A32,32,0,0,1,80,56h96A32,32,0,0,1,208,88Z", "opacity", "0.2")
    ...
    static Icon jarLabel() {
        return Icon.svg("0 0 256 256")
                .theme(IconTheme.FILLED)
                .element("path", "d", "M208,104v80H48V104Z", "opacity", "0.2")
    ...
    static Icon jeep() {
        return Icon.svg("0 0 256 256")
                .theme(IconTheme.FILLED)
                .element("path", "d", "M224,96H32L42.65,46.32A8,8,0,0,1,50.47,40H205.53a8,8,0,0,1,7.82,6.32Z", "opacity", "0.2")
    ...
    static Icon joystick() {
        return Icon.svg("0 0 256 256")
                .theme(IconTheme.FILLED)
                .element("path", "d", "M216,160v48a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V160a8,8,0,0,1,8-8H208A8,8,0,0,1,216,160ZM128,88A32,32,0,1,0,96,56,32,32,0,0,0,128,88Z", "opacity", "0.2")
