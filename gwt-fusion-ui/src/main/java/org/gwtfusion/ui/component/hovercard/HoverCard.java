...
public final class HoverCard extends BaseComponent<HoverCard> {
    ...
    public static final String CONTENT_CLASSES = "fixed z-50 grid w-80 gap-3 rounded-md border border-border bg-popover p-4 text-sm text-popover-foreground shadow-lg";
